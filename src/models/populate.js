...
// author and fans are path which poing to any other collections documents.
...
// because we are managing the stories ref in the author but still we did't store any atory 
...
await Story().finsd().populate({path: 'persion'})
...
// which will do all the magic for us. whit this we are free form managing stories [] in 
